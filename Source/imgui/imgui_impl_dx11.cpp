...
void ImGui_ImplGlfw_SetSizeCallback(GLFWwindow* window, int w, int h)
{
...
bool    ImGui_ImplDX11_Init(GLFWwindow* window, bool install_callbacks, ID3D11Device* device, ID3D11DeviceContext* device_context)
{
	g_Window = window;
    g_pd3dDevice = device;
